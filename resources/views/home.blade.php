...
<head>
    ...
    <style>
        body {
            background-image: url('image/bg.jpg'); /* Ganti dengan path gambar yang sesuai */
...
<body>
    ...
    <img src="{{ ('image/POLBENG.png') }}" width="200" height="200" style="border-radius: 50%; margin-left: 10px;" />
